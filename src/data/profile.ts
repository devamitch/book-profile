import type { Experience, Project, SkillCategory, Testimonial, BlogPost, Education, Stat, StoryBeat } from '../types'
...
export const PROFILE = {
  ...
  roles: ['VP Engineering', 'Principal Architect', 'CTO', 'Technical Lead', '0→1 Builder'],
  ...
  availability: 'Open for high-impact global collaborations and contract roles.',
  ...
  ethos: {
    ...
    principles: [
      { label: 'Skin in the Game', detail: 'I treat your product like it\'s my own company. I fight till the end to ensure the architecture survives reality.' },
      { label: 'Tackling the Critical', detail: 'When things break, I step in. I solve the blockers that make other engineers quit.' },
      { label: 'Building the Team', detail: 'I don\'t just write code. I mentor, train, and instill strict engineering discipline in the teams I lead.' },
      { label: 'Zero-to-One Focus', detail: 'Taking raw visions and turning them into scalable, robust technical realities from absolute zero.' },
    ],
  },
} as const
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    tech: ['React Native', 'Next.js', 'NestJS', 'AWS', 'TensorFlow', 'MediaPipe', 'RAG', 'Kubernetes', 'C++/Swift/Kotlin', 'Pinecone'],
  },
  {
    id: 'nonceblox',
    ...
    tech: ['React Native', 'Solidity', 'Web3.js', 'TypeScript', 'Node.js', 'GraphQL', 'Reanimated', 'C++', 'Ethereum'],
  },
  {
    id: 'early',
...
export const PROJECTS: Project[] = [
  {
    ...
    tech: ['React Native', 'C++/Swift/Kotlin', 'LLMs', 'RAG Pipelines', 'MediaPipe', 'HIPAA'],
    color: '#E8771A',
    featured: true,
    impact: ['Proprietary game engine — zero external deps', 'LLM task generation at runtime', 'RAG pipeline for HIPAA-compliant medical data', 'Computer vision retina analysis', '21-person team recruited & trained'],
  },
  {
    id: 'nexus',
    ...
    tech: ['Next.js', 'Agentic AI', 'Multi-channel', 'Real-time Analytics', 'NestJS'],
    color: '#C9A84C',
    featured: true,
    impact: ['5+ platforms unified into one AI brain', 'Autonomous campaign recommendations', 'Real-time cross-channel analytics'],
  },
  {
    id: 'lunacare',
    ...
    tech: ['React Native', 'AI/ML', 'Encrypted Storage', 'Health APIs', 'Node.js'],
    color: '#D4A5C5',
    featured: true,
    impact: ['Personalised cycle + mood + sleep tracking', 'AI wellness recommendations engine', 'Privacy-first — zero third-party data sells'],
  },
  {
    id: 'vulcan',
    name: 'Vulcan Eleven',
    ...
    tech: ['React Native', 'Reanimated', 'C++', 'Razorpay', 'Binance Pay', 'Blockchain'],
    color: '#FF6B35',
    link: 'https://apps.apple.com/app/vulcan-eleven/id6462420052',
    impact: ['50K+ active users', '35% transaction growth', 'Binance Pay + Razorpay integration'],
  },
  {
    id: 'housezy',
    name: 'Housezy',
    ...
    tech: ['Expo Router', 'GraphQL', 'Socket.io', 'PayU', 'Google Pay', 'CI/CD'],
    color: '#00B4A0',
    link: 'https://apps.apple.com/us/app/housezy/id6471949955',
    impact: ['Subscription billing layer', 'Real-time notifications', 'PayU + Google Pay integration'],
  },
  {
    id: 'defi11',
    name: 'DeFi11',
    ...
    impact: ['100% on-chain prize pools', 'Smart contract architecture', 'Zero-trust design'],
  },
  {
    id: 'musicx',
    name: 'MusicX',
    ...
    impact: ['Blockchain royalty system', 'C++ native modules', '60fps animations'],
  },
  {
    id: 'be4you',
    name: 'Be4You',
    ...
    color: '#F15BB5',
    impact: ['Full MVP for seed round', 'Real-time video + chat + location', '90-day delivery'],
  },
  {
    id: 'prolandly',
    name: 'ProLandly',
    ...
    color: '#FF9800',
    impact: ['Cultural preservation through technology', 'Economic empowerment layer', 'Community-first mobile platform'],
  },
  {
    id: 'cryptocoffee',
    ...
    tech: ['TypeScript', 'Lottie', 'Moti', 'Wallet Integration', 'React Native'],
    color: '#6366F1',
    impact: ['Real-time crypto prices', 'Wallet integration', 'Community features'],
  },
]
...
export const SKILLS: SkillCategory[] = [
  {
    cat: 'Mobile',
    color: '#E8771A',
    items: ['React Native (Expert, Bridgeless)', 'Expo', 'TypeScript', 'Native Modules (C++/Swift/Kotlin)', 'Reanimated', 'iOS & Android'],
  },
  {
    cat: 'AI & ML',
    color: '#C9A84C',
    items: ['Custom Prompt-Engineered AI (Aura AI)', 'RAG Pipelines', 'Agentic AI', 'LLM Integration (OpenAI/Claude)', 'Computer Vision (MediaPipe)', 'TensorFlow'],
  },
  {
    cat: 'Blockchain',
    color: '#DAA520',
    items: ['Solana (Rust/Anchor)', 'Ethereum (Solidity)', 'Web3.js / Ethers.js / Viem', 'WalletConnect / Wagmi', 'Smart Contracts', 'DeFi & NFTs'],
  },
  {
    cat: 'Backend & Cloud',
    color: '#D4A5C5',
    items: ['NestJS / Node.js / Django', 'GraphQL / REST', 'PostgreSQL / MongoDB / Redis', 'AWS (Lambda, S3, Amplify, EC2)', 'Docker & Kubernetes', 'CI/CD (Fastlane, GitHub Actions)'],
  },
  {
    cat: 'Frontend',
    color: '#87CEEB',
    items: ['React.js / Next.js 15', 'Redux / Zustand', 'Framer Motion / GSAP', 'Tailwind CSS / MUI', 'Electron', 'TypeScript'],
  },
  {
    cat: 'Payments',
    color: '#90EE90',
    items: ['Stripe / PayPal', 'Razorpay', 'Binance Pay', 'Google Pay / PayU', 'Crypto on-ramps', 'Subscription Billing'],
  },
  {
    cat: 'Leadership',
    color: '#FFB347',
    items: ['Team Building (21+)', 'Technical Mentorship', 'Agile/Scrum', 'Stakeholder Management', '0-to-1 Architecture', 'VP-Level Operations'],
  },
]
...
export const BLOGS: BlogPost[] = [
  {
    ...
    color: '#E8771A',
    date: 'Jan 17, 2025',
    teaser: 'Git is a superpower. Whether you\'re a beginner or experienced developer, mastering Git will transform your workflow and collaboration.',
  ...
  },
  {
    ...
    color: '#C9A84C',
    date: 'Nov 2024',
    teaser: 'The new architecture changes everything. Here\'s what actually breaks in production and how to fix it before your users notice.',
  ...
  },
  {
    ...
    color: '#DAA520',
    date: 'Nov 2024',
    teaser: 'How we built retrieval pipelines for sensitive medical data without violating compliance — lessons from a real HealthTech build.',
    link: 'https://devamitch.medium.com/',
  },
  {
    ...
    color: '#D4A5C5',
    date: 'Nov 23, 2024',
    teaser: 'Writing reusable functions and handling errors in Rust and Go. Each concept introduced step-by-step in plain English.',
    link: 'https://devamitch.medium.com/',
  },
  {
    ...
    color: '#87CEEB',
    date: 'Oct 25, 2024',
    teaser: 'A practical guide to choosing between Expo\'s managed workflow and Bare React Native for your next project.',
    link: 'https://devamitch.medium.com/',
  },
]

export const EDUCATION: Education[] = [
  { degree: 'MCA', school: 'Techno Main Salt Lake, Kolkata', period: '2018–2021', gpa: '8.61 CGPA' },
  { degree: 'BCA', school: 'The Heritage Academy, Kolkata', period: '2014–2017', gpa: '' },
]
